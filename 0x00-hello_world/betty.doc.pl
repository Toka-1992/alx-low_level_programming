...
Output format selection (mutually exclusive):
    ...
    -docbookOutput DocBook format.

    -htmlOutput HTML format.

    -html5Output HTML5 format.

    -listOutput symbol list format. This is for use by docproc. This is the default.

    -manOutput troff manual page format.

    -rstOutput reStructuredText format.
...
Output selection (mutually exclusive):
    ...
    -function NAMEOnly output documentation for the given function(s)

    or DOC: section title(s). All other functions and DOC:

    sections are ignored. May be specified multiple times.

    -nofunction NAMEDo NOT output documentation for the given function(s);
...
Output selection modifiers:
	...
	-no-doc-sectionsDo not output DOC: sections.



Other parameters:

	-vVerbose output, more warnings and other information.

	-hprint STDOUT this help.
